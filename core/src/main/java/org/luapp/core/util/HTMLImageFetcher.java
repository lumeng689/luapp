...
public class HTMLImageFetcher {
    ...
    public static void main(String[] args) {
        String html = "这张图片很漂亮啊！" + "<img src='http://techcn.com.cn/uploads/201004/12705551313uy0urE3.jpg' alt=''/>"
    ...
    private static boolean isImageFile(String fileName) {
        String[] imgSuffixs = { ".gif", ".jpg", ".jpeg", ".png", ".tiff", ".bmp", };
